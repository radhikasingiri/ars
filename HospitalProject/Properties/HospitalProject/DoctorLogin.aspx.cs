...
namespace HospitalProject
{
    public partial class DoctorLogin : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string cmdstr2 = "Select UserID from Users where UserName='" + txtusername.Text + "' and Password='" + txtpassword.Text + "' and roleId=1";
            SqlCommand userid = new SqlCommand(cmdstr2, con2);
            int temp2 = Convert.ToInt32(userid.ExecuteScalar().ToString());
            con2.Close();
            if (temp2 != 0)
            {
                Response.Redirect("DoctorActions.aspx?DoctorId=" + temp2.ToString());
            }
        }
    }
}