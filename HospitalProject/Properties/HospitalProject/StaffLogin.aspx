<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="StaffLogin.aspx.cs" Inherits="HospitalProject.StaffLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="rpanelr" style="margin: 20px 100px 70px 240px; height: auto;">
        <table class="style1" style="height: auto; width: 500px;">
            ...
            <tr>
                <td class="style2" style="width: 25px">&nbsp;</td>
                <td class="style3" style="width: 25px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: #0000FF; font-size: large; vertical-align: middle; text-decoration: underline;">STAFF LOGIN</td>
            </tr>
            <tr>
                <td class="style2" style="width: 25px">&nbsp;</td>
                <td class="style3" style="width: 25px">&nbsp;</td>
